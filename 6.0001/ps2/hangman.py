        ...
        if char in letters_guessed:
            ...
            for i, character in enumerate(secret_word):
                if char == character:
                    char_pos.append(i)
            for i in char_pos:
                guessed_word = guessed_word[:i] + char + guessed_word[i+1:]
...
def get_available_letters(letters_guessed):
    ...
    return letters
def guesses_print(guesses_left):
    print("You have " + str(guesses_left) + " guesses left.")

def warnings_print(warnings_left):
...
def hangman_with_hints(secret_word):
    ...
    * If the guess is the symbol *, print out all words in wordlist that
    ...
    while not is_word_guessed(secret_word, letters_guessed):
        ...
        if guess.lower() not in string.ascii_lowercase and guess != "*":
            if warnings_left > 0:
                print("Oops! That is not a valid letter.")
                warnings_left -= 1
                warnings_print(warnings_left)
            ...
            if guess in letters_guessed and guess != "*":
                if warnings_left > 0:
                    print("Oops! You've already guessed that letter.")
                    warnings_left -= 1
                    warnings_print(warnings_left)
    ...
    if is_word_guessed(secret_word, letters_guessed) == True:
        ...
        print("your total score for this game is: " + str(guesses_left*len(set(secret_word))))
